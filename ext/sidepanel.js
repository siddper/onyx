...
markdownInput.addEventListener("keydown", (e) => {
  if (e.key === "Tab") {
    const handled = handleListIndentOnTab(markdownInput, (nextValue, cursorPos) => {
  ...
  if (e.key === "Delete" || e.key === "Backspace") {
    const handled = handleListClearOnDelete(markdownInput, (nextValue, cursorPos) => {
      markdownInput.value = nextValue;
      markdownInput.setSelectionRange(cursorPos, cursorPos);
      updatePreview();
      updatePaneCounts();
  ...
  if (e.key === "Enter") {
    const handled = handleListContinuation(markdownInput, (nextValue, cursorPos) => {
      markdownInput.value = nextValue;
      markdownInput.setSelectionRange(cursorPos, cursorPos);
      updatePreview();
      updatePaneCounts();
